...
OdometryFuser::OdometryFuser() : tf_listener_(tf_buffer_), support_state_cache_(100) {
  ...
  while (ros::ok()) {
    ...
    //imu_without_yaw_component.rotation = nan 

    /*
    ROS_INFO("motion_odometry_yaw.origin:%f,%f,%f", motion_odometry_yaw.getOrigin().getX(), motion_odometry_yaw.getOrigin().getY(), motion_odometry_yaw.getOrigin().getZ());
    ROS_INFO("motion_odometry_yaw.rotation:%f,%f,%f", motion_odometry_yaw.getRotation().getX(), motion_odometry_yaw.getRotation().getY(), motion_odometry_yaw.getRotation().getZ());
    ROS_INFO("rotation_point_in_base.origin:%f,%f,%f", rotation_point_in_base.getOrigin().getX(), rotation_point_in_base.getOrigin().getY(), rotation_point_in_base.getOrigin().getZ());
    ROS_INFO("rotation_point_in_base.rotation:%f,%f,%f", rotation_point_in_base.getRotation().getX(), rotation_point_in_base.getRotation().getY(), rotation_point_in_base.getRotation().getZ());
    ROS_INFO("imu_without_yaw_component.origin:%f,%f,%f", imu_without_yaw_component.getOrigin().getX(), imu_without_yaw_component.getOrigin().getY(), imu_without_yaw_component.getOrigin().getZ());
    ROS_INFO("imu_without_yaw_component.rotation:%f,%f,%f", imu_without_yaw_component.getRotation().getX(), imu_without_yaw_component.getRotation().getY(), imu_without_yaw_component.getRotation().getZ());
    ROS_INFO("base_link_in_rotation_point.origin:%f,%f,%f", base_link_in_rotation_point.getOrigin().getX(), base_link_in_rotation_point.getOrigin().getY(), base_link_in_rotation_point.getOrigin().getZ());
    ROS_INFO("base_link_in_rotation_point.rotation:%f,%f,%f", base_link_in_rotation_point.getRotation().getX(), base_link_in_rotation_point.getRotation().getY(), base_link_in_rotation_point.getRotation().getZ());
    */
...
int main(int argc, char **argv) {
  ...
  ROS_INFO("odometryfuser node init");
  OdometryFuser o;
}
