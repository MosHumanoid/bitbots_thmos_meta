...
class SupervisorController:
    def __init__(self, ros_active=False, mode='normal', do_ros_init=True, base_ns='', model_states_active=True):
        ...
        self.robot_names = ["red_player_1", "rory", "jack", "donna"]
        self.robot_nodes = {}
    ...
    def set_initial_poses(self, req=None):
        self.reset_robot_pose_rpy([-1, 3, 0.42], [0, 0.24, -1.57], name="red_player_1")
    ...
    def get_robot_orientation_rpy(self, name="red_player_1"):
    ...
    def get_robot_velocity(self, name="red_player_1"):
        velocity = self.robot_nodes[name].getVelocity()
        return velocity[:3], velocity[3:]

    def get_link_pose(self, link, name="red_player_1"):
    ...
    def get_link_velocities(self, link, name="red_player_1"):
